...
if __name__=="__main__":
    ...
    ekf_pub = rospy.Publisher('/ekf_pub_off', ekfparam, queue_size = 1)
    ...
    rospy.Subscriber("/slam_out_pose2", PoseStamped, GPSPosreceived)             # subsampled slam out
    rospy.Subscriber("/imu_virtual_off", Imu, IMU1MeasurementAvailable)     # /imu/imu -> virtual
