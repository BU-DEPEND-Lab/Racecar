...
populationSize = 2
generations = 1
mutationRate = 0.1 # each value has a 10% chance of being chosen to be mutated
...
def create_individual():
    ...
    Segment = random.int(1,6)
    Path_width =  2.0 #meters
    Gazebo_box_limit =  500
    Feature1 = random.int(0,10) # number of turns
    Feature2 = random.uniform(0,1) # complexity

     
    chromosome = np.array([Segment,Path_width,Gazebo_box_limit, Feature1, Feature2])         
    return chromosome
